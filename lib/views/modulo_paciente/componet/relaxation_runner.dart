...
final Map<String, MuscleGroup> kAllGroups = {
  ...
  'cuello': const MuscleGroup(
    ...
    relaxationSteps: [
      ...
      'Siente el peso de la cabeza sostenido naturally',
    ],
  ),
...
class RelaxationRunner extends StatefulWidget {
  final int durationSeconds;
  final VoidCallback onComplete;

  const RelaxationRunner({
    super.key,
  ...
  @override
  State<RelaxationRunner> createState() => _RelaxationRunnerState();
}

class _RelaxationRunnerState extends State<RelaxationRunner>
