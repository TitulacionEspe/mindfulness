...
static const Color greyBg = Color(0xFFE9ECEF); // Gris para el placeholder del paciente

static const Color figmaBlue = Color(0xFF003B5C); 
static const Color figmaGrayBg = Color(0xFFF0F3F5); // Fondo de categorías inactivas
static const Color figmaBlack = Color(0xFF212529); // Texto oscuro y chips activos
static const Color figmaMuted = Color(0xFF6C757D); // Texto gris de descripción
