...
void main() {
  group('AuthRepository - Exception Mapping Tests', () {
    ...
    test('should map email_rate_limit to friendly Spanish message', () {
      ...
      expect(mapError(technicalError), 'Demasiados intentos. Espera unos minutos e intenta de nuevo');
    });
    ...
    test('should map email_already_registered to friendly Spanish message', () {
      ...
      String mapError(String e) {
        if (e.contains('Email not') || e.contains('email_already') || e.contains('Email already')) {
          return 'Este correo electrónico ya está registrado';
        }
        return e;
      }

      expect(mapError(technicalError), 'Este correo electrónico ya está registrado');
    });
  });
}
